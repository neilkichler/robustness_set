...
PRETRAINED_FOLDER_TIME = "27_05_2021_17_38_35"


def plot_feature_selection_worst_case_per_epoch_all_layers(aggs, n_runs, sample_epochs, title=False, show_plot=False, show_cbar=False, save_plot=False):
    percent = 100
    image_dim = (28, 28)
...
if __name__ == "__main__":
    ...
    should_perform_feature_selection = False
    ...
    for frun in flist:
        ...
        with open(fname, "rb") as handle:
            ...
            if should_perform_feature_selection:
                ...
                print(f"performed feature selection for: {frun}")
